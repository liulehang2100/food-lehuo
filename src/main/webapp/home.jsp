 ...
 <div class="header">
	...
	<!-- start search-->	
		<div class="banner">
			...
			<label></label>
			<h4 class="animated wow fadeInTop" data-wow-duration="1000ms" data-wow-delay="500ms">您好，欢迎来到乐活！！</h4>
						...
						<a href="details.html">
							<div class="content-item">
								...
								<div class=" news-bottom2">
									<ul class="grid-news">
										<li><span><i class="glyphicon glyphicon-calendar"> </i>时间</span><b>/</b></li>
										<li><span><i class="glyphicon glyphicon-comment"> </i>几个留言</span><b>/</b></li>
										<li><span><i class="glyphicon glyphicon-share"> </i>分享</span></li>
									</ul>
									<p>一大堆描述</p>
								</div>
							</div>
